...
const promoData = {
    m: {
        ...
        promoText: `<strong>Promo 1</strong><p>Duas pizzas de <strong>6</strong> pedaços por apenas <strong>R$ 68,90</strong>!</p>
            ...
            + `<div class="modal-btn-container"><button class="modal-action-btn" onclick="window.location.href='promodobrom.html'">Quero essa!</button></div>`
    },
    g: {
        ...
        promoText: `<strong>Promo 2</strong><p>Duas pizzas de <strong>8</strong> pedaços por apenas <strong>R$ 87,90</strong>!</p>
            <em>Válido para pizzas: <ul>
                ...
                <p>Permitido a escolha meio a meio, entre esses sabores.<br>Promoção válida para <strong>todas</strong> as unidades.</p>`
            + `<div class="modal-btn-container"><button class="modal-action-btn" onclick="window.location.href='promodobrog.html'">Quero essa!</button></div>`
    }
};
